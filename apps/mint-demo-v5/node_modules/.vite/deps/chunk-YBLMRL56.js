import {
  ...
  size2,
  toHex
} from "./chunk-ZOZDKQDI.js";
import {
  Chi,
  HashMD,
  Maj
} from "./chunk-V4SKF4I6.js";
import {
  clean,
  createHasher,
  rotl
...
function __read(o, n) {
  ...
  try {
    while ((n === void 0 || n-- > 0) && !(r = i.next()).done) ar3.push(r.value);
  } catch (error) {
    e = { error };
  } finally {
    try {
...
var __spreadArray = function(to3, from8, pack) {
  if (pack || arguments.length === 2) for (var i = 0, l = from8.length, ar3; i < l; i++) {
    if (ar3 || !(i in from8)) {
      if (!ar3) ar3 = Array.prototype.slice.call(from8, 0, i);
      ar3[i] = from8[i];
    }
  }
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-IHNPVYKR.js");
  const signature_ = (() => {
...
var An = class extends xn {
  ...
  digestInto(e) {
    ...
    if (D2 > c.length) throw new Error("_sha2: outputLen bigger than state");
    for (let l = 0; l < D2; l++) u.setUint32(4 * l, c[l], s);
  }
  digest() {
...
function sr(t) {
  ...
  if (r === 1) {
    ...
    return function(i, D2) {
      const c = i.pow(D2, a);
      if (!i.eql(i.sqr(c), D2)) throw new Error("Cannot find square root");
      return c;
    };
  }
  const s = (n + N) / nt;
  return function(u, i) {
    ...
    for (; !u.eql(p, u.ONE); ) {
      ...
      let w = 1;
      for (let g = u.sqr(p); w < D2 && !u.eql(g, u.ONE); w++) g = u.sqr(g);
...
function ir(t) {
  ...
  if (t % Ce === Be) {
    ...
    return function(r, o) {
      ...
      if (!r.eql(r.sqr(D2), o)) throw new Error("Cannot find square root");
      return D2;
    };
  }
  return sr(t);
...
function lr(t, e) {
  return { constTimeNegate: zt, hasPrecomputes(n) {
    ...
    for (let l = 0; l < a; l++) {
      ...
      if (o === Se) break;
      let w = Number(o & i);
      if (o >>= c, w > u && (w -= D2, o += gt), w === 0) continue;
...
function yr(t) {
  ...
  const v = xe((y, f) => {
    ...
    if (V !== Y2) throw new Error("bad point: equation left != right (1)");
    const Z = c(E * B), X2 = c(C2 * A);
    if (Z !== X2) throw new Error("bad point: equation left != right (2)");
    return true;
  });
  class d {
    constructor(f, b, E, B) {
...
function Ir(t, e) {
  ...
  function l(h) {
    ...
    for (var d = (L - v) * c + 1 >>> 0, m = new Uint8Array(d); v !== L; ) {
      for (var F2 = h[v], q = 0, z = d - 1; (F2 !== 0 || q < S) && z !== -1; z--, q++) F2 += 256 * m[z] >>> 0, m[z] = F2 % u >>> 0, F2 = F2 / u >>> 0;
  ...
  function p(h) {
    ...
    if (h[g] !== " ") {
      ...
      for (var L = (h.length - g) * D2 + 1 >>> 0, d = new Uint8Array(L); h[g]; ) {
        ...
        if (m === 255) return;
        for (var F2 = 0, q = L - 1; (m !== 0 || F2 < v) && q !== -1; q--, F2++) m += u * d[q] >>> 0, d[q] = m % 256 >>> 0, m = m / 256 >>> 0;
...
var Qn2 = (t, e) => {
  for (var n in e || (e = {})) js.call(e, n) && Ze2(t, n, e[n]);
  if (Jn2) for (var n of Jn2(e)) ks.call(e, n) && Ze2(t, n, e[n]);
  return t;
};
...
async function ai({ id: t, topic: e, wcDeepLink: n }) {
  ...
  try {
    ...
    if (f === J2.browser) {
      ...
      hr2(i);
    } else f === J2.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(i);
  } catch (o) {
    console.error(o);
  }
}
...
async function ui(t, e) {
  let n = "";
  try {
    if (zt2() && (n = localStorage.getItem(e), n)) return n;
    n = await t.getItem(e);
  } catch (r) {
    console.error(r);
  }
...
function Si(t) {
  for (let e = 0; e < t.length; e++) t[e] = Br2(t[e]);
  return t;
}
var Ot2 = Er2 ? (t) => t : Si;
...
var qn2 = class _qn extends Ie2 {
  constructor(e, n, r, o = false, s = 24) {
    if (super(), this.pos = 0, this.posOut = 0, this.finished = false, this.destroyed = false, this.enableXOF = false, this.blockLen = e, this.suffix = n, this.outputLen = r, this.enableXOF = o, this.rounds = s, mt(r), !(0 < e && e < 200)) throw new Error("only keccak-f1600 function is supported");
  ...
  digestInto(e) {
    if (on2(e, this), this.finished) throw new Error("digest() was already called");
...
var Ki = class extends Rr2 {
  ...
  process(e, n) {
    for (let u = 0; u < 16; u++, n += 4) _t2[u] = e.getUint32(n, false);
    for (let u = 16; u < 64; u++) {
...
var cn = class extends Rr2 {
  ...
  process(e, n) {
    for (let L = 0; L < 16; L++, n += 4) Tt2[L] = e.getUint32(n), Rt2[L] = e.getUint32(n += 4);
    for (let L = 16; L < 80; L++) {
  ...
  update(e) {
    ...
    for (let a = 0; a < s; ) {
      ...
      if (l === n && !(c % 4) && a + l < s) {
        ...
        Ot2(u);
        for (let h = 0; a + n < s; h += o.length, a += n) this.length += n, this.compress(u, h, false);
        Ot2(u);
        continue;
      }
...
var ln = (t, e) => {
  for (var n in e || (e = {})) pf.call(e, n) && Hr2(t, n, e[n]);
  if (Pr2) for (var n of Pr2(e)) gf.call(e, n) && Hr2(t, n, e[n]);
  return t;
};
...
function Wr2(t, e, n, r = {}) {
  return n?.sort((o, s) => o.localeCompare(s)), { att: { [t]: hn(e, n, r) } };
}
function Yr2(t, e, n) {
  var r;
  t.att[e] = ln({}, n);
...
var Rf = (t, e) => {
  function n(r, ...o) {
    if (nt2(r), !Of) throw new Error("Non little-endian hardware is not yet supported");
    ...
    return { encrypt(c, u) {
      ...
      if (nt2(c), s && c.length < s) throw new Error("invalid ciphertext length: smaller than tagLength=" + s);
...
function Df(t, e, n, r, o, s, i, f) {
  ...
  for (let w = 0; w < a; i++) {
    if (t(e, n, r, c, i, f), i >= oo2) throw new Error("arx: counter overflow");
    const y = Math.min(Ue2, a - w);
    if (u && y === Ue2) {
      const x2 = w / 4;
      if (w % 4 !== 0) throw new Error("arx: invalid block position");
      for (let R = 0, M2; R < Hf; R++) M2 = x2 + R, g[M2] = h[M2] ^ c[R];
      w += Ue2;
      continue;
    }
    for (let x2 = 0, R; x2 < y; x2++) R = w + x2, s[R] = o[R] ^ l[x2];
    w += y;
  }
}
function Mf(t, e) {
  ...
  return yn2(o), yn2(i), bn2(s), bn2(n), (f, a, l, c, u = 0) => {
    nt2(f), nt2(a), nt2(l);
    const h = l.length;
    if (c === void 0 && (c = new Uint8Array(h)), nt2(c), yn2(u), u < 0 || u >= oo2) throw new Error("arx: counter overflow");
    if (c.length < h) throw new Error(`arx: output (${c.length}) is shorter than data (${h})`);
    const g = [];
    let w = f.length, y, x2;
    if (w === 32) g.push(y = wn(f)), x2 = Pf;
    else if (w === 16 && n) y = new Uint8Array(32), y.set(f), y.set(f, 16), x2 = kf, g.push(y);
...
var Vf = class {
  constructor(e) {
    ...
    for (let c = 0; c < 8; c++) this.pad[c] = G2(e, 16 + 2 * c);
  }
  process(e, n, r = false) {
...
function Xf(t, e, n, r = 32) {
  ...
  for (let c = 0; c < s; c++) vn2[0] = c + 1, a.update(c === 0 ? uo2 : l).update(n).update(vn2).digestInto(l), i.set(l, o * c), f._cloneInto(a);
...
function rt2(t, e, n) {
  ...
  else if (nn2(e)) r = Uint8Array.from(e);
  else throw new Error(t + " must be hex string or Uint8Array");
  const o = r.length;
  if (typeof n == "number" && o !== n) throw new Error(t + " of length " + n + " expected, got " + o);
  return r;
...
function yo2(t, e) {
  ...
  if (r !== Q2) throw new Error("invert: does not exist");
  return lt2(o, e);
}
function mo2(t, e) {
...
function oc(t) {
  ...
  let e = t - Q2, n = 0;
  for (; e % Dt2 === ot; ) e /= Dt2, n++;
  let r = Dt2;
  const o = Yt2(t);
  for (; xo2(o, r) === 1; ) if (r++ > 1e3) throw new Error("Cannot find square root: probably non-prime P");
  if (n === 1) return mo2;
  let s = o.pow(r, e);
  const i = (e + Q2) / Dt2;
  return function(a, l) {
    if (a.is0(l)) return l;
    if (xo2(a, l) !== 1) throw new Error("Cannot find square root");
...
function cc(t, e, n) {
  ...
  if (n === Q2) return e;
  let r = t.ONE, o = e;
  for (; n > ot; ) n & Q2 && (r = t.mul(r, o)), o = t.sqr(o), n >>= Q2;
  return r;
}
...
function pc(t, e) {
  return { constTimeNegate: le2, hasPrecomputes(n) {
    ...
    let s = n;
    for (; r > Xt2; ) r & Mt2 && (o = o.add(s)), s = s.double(), r >>= Mt2;
    return o;
  }, precomputeWindow(n, r) {
...
function gc(t, e, n, r) {
  ...
  for (; n > Xt2 || r > Xt2; ) n & Mt2 && (s = s.add(o)), r & Mt2 && (i = i.add(o)), o = o.double(), n >>= Mt2, r >>= Mt2;
  return { p1: s, p2: i };
}
function bc(t, e, n, r) {
  dc(n, t), hc(r, e);
  ...
  for (let g = u; g >= 0; g -= a) {
    ...
    let w = i;
    for (let y = c.length - 1, x2 = i; y > 0; y--) x2 = x2.add(c[y]), w = w.add(x2);
...
function yc(t, e, n = {}) {
  ...
  for (const f of ["p", "n", "h"]) {
    const a = e[f];
    if (!(typeof a == "bigint" && a > Xt2)) throw new Error(`CURVE.${f} must be positive bigint`);
  }
...
function wc(t) {
  ...
  function _(d, m) {
    const p = $(L(m), V(d));
    if (p === de2) throw new Error("invalid private or public key received");
    return M2(p);
  }
  function k2(d) {
    return _(d, R);
...
var vt2 = { Err: Sc, _tlv: { encode: (t, e) => {
  ...
  const { Err: e } = vt2;
  if (t < he2) throw new e("integer: negative integers are not allowed");
  let n = $e2(t);
...
function _c(t, e = {}) {
  ...
  function a($, d, m) {
    ...
    if (Re2("isCompressed", m), m) {
      ...
      const B = !n.isOdd(b);
      return Ht2(Ro2(B), v);
    } else return Ht2(Uint8Array.of(4), v, n.toBytes(b));
  }
  function l($) {
    at($);
  ...
  const M2 = ho2(($, d) => {
    ...
    if (n.eql(b, n.ONE)) return { x: m, y: p };
    const v = $.is0();
  ...
  class _ {
    ...
    multiplyUnsafe(d) {
      ...
      if (d === he2 || p.is0()) return _.ZERO;
      if (d === pe2) return p;
      if (j2.hasPrecomputes(this)) return this.multiply(d);
      if (m) {
        const { k1neg: b, k1: v, k2neg: B, k2: E } = m.splitScalar(d), { p1: I, p2: S } = gc(_, p, v, E);
        return V(m.beta, I, S, b, B);
      } else return j2.wNAFCachedUnsafe(p, d);
    }
...
function Tc(t, e, n = {}) {
  ...
  class h {
    ...
    toBytes(b) {
      if (b === "compact") return Ht2(i.toBytes(this.r), i.toBytes(this.s));
      if (b === "der") return fn(vt2.hexFromSig(this));
  ...
  function R(p, b, v = true) {
    if (x2(p) === true) throw new Error("first arg must be private key");
    if (x2(b) === false) throw new Error("second arg must be public key");
  ...
  function m(p, b, v, B = $) {
    ...
    if (O !== void 0 && !["compact", "der", "js"].includes(O)) throw new Error('format must be "compact", "der" or "js"');
    ...
    try {
      ...
      if (A) {
        try {
          ...
          if (!(yt2 instanceof vt2.Err)) throw yt2;
        }
    ...
    if (!U || I && U.hasHighS()) return false;
    S && (b = e.hash(b));
...
function Gc(t) {
  ...
  if (Vt2(e) === ee && typeof t.senderPublicKey > "u") throw new Error("Missing sender public key for type 1 envelope");
...
function Xc(t, e) {
  const n = Me2({ encoded: t, encoding: e?.encoding });
  return Ho2({ type: Vt2(n.type), senderPublicKey: typeof n.senderPublicKey < "u" ? toString3(n.senderPublicKey, tt) : void 0, receiverPublicKey: e?.receiverPublicKey });
}
function Ho2(t) {
  const e = t?.type || Cn2;
  if (e === ee) {
...
function ta(t, e) {
  ...
  if (!Dc.verify(concat3([i, f]), l, c)) throw new Error("Invalid signature");
  return sn(t).payload;
}
var Mo2 = "irn";
function ea(t) {
  return t?.relay || { protocol: Mo2 };
}
function na(t) {
  const e = C[t];
...
var la = (t, e) => {
  for (var n in e || (e = {})) aa.call(e, n) && zo2(t, n, e[n]);
  if (Fo2) for (var n of Fo2(e)) ua.call(e, n) && zo2(t, n, e[n]);
  return t;
};
...
function ha(t, e) {
  ...
  const r = {};
  for (const [o, s] of Object.entries(t)) r[o] = { methods: s.methods, events: s.events, chains: s.accounts.map((i) => `${i.split(":")[0]}:${i.split(":")[1]}`) };
  return r;
}
function pa(t) {
  var e;
  ...
  Object.keys(o).forEach((c) => {
    ...
    u.forEach((y) => {
      if (!w.some((x2) => x2.includes(y))) throw new Error(`No accounts provided for chain ${y} in namespace ${c}`);
  ...
  Object.keys(s).forEach((c) => {
    ...
    }), V = R?.map((_) => o[c].accounts.filter((k2) => k2.includes(`${_}:`))).flat();
...
function ga(t, e) {
  ...
  const n = Xo(e);
  for (const [r, o] of Object.entries(n)) o.methods ? o.methods = ct2(o.methods, t) : o.methods = t, o.events = ["chainChanged", "accountsChanged"];
  return n;
}
function ba(t, e) {
  var n, r, o, s, i, f;
  const a = ye2(t), l = ye2(e), c = {}, u = Object.keys(a).concat(Object.keys(l));
  for (const h of u) c[h] = { chains: ct2((n = a[h]) == null ? void 0 : n.chains, (r = l[h]) == null ? void 0 : r.chains), methods: ct2((o = a[h]) == null ? void 0 : o.methods, (s = l[h]) == null ? void 0 : s.methods), events: ct2((i = a[h]) == null ? void 0 : i.events, (f = l[h]) == null ? void 0 : f.events) };
  return c;
}
...
function va(t, e) {
  let n = null;
  return it2(t?.publicKey, false) || (n = Et2("MISSING_OR_INVALID", `${e} controller public key should be a string`)), n;
}
function Hn2(t) {
  let e = true;
...
function ss(t, e) {
  let n = null;
  return Hn2(t?.methods) ? Hn2(t?.events) || (n = Kt2("UNSUPPORTED_EVENTS", `${e}, events should be an array of strings or empty array for no events`)) : n = Kt2("UNSUPPORTED_METHODS", `${e}, methods should be an array of strings or empty array for no methods`), n;
}
function Dn(t, e) {
  let n = null;
  return Object.values(t).forEach((r) => {
...
function Ea(t, e, n) {
  ...
  if (t && Ve2(t)) {
    ...
    const s = ns(t, e, n);
    s && (r = s);
  } else r = Et2("MISSING_OR_INVALID", `${e}, ${n} should be an object with data`);
  return r;
}
function is(t, e) {
  let n = null;
  if (t && Ve2(t)) {
    ...
    const o = os(t, e);
    o && (n = o);
  } else n = Et2("MISSING_OR_INVALID", `${e}, namespaces should be an object with data`);
  return n;
}
function fs(t) {
...
function ps(t) {
  Bt2() && typeof global < "u" && global != null && global.NetInfo && global?.NetInfo.addEventListener((e) => t(e?.isConnected));
}
function Pa() {
  var t;
...
*/
//# sourceMappingURL=chunk-YBLMRL56.js.map
