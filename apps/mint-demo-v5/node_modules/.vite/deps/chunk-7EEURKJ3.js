  ...
  try {
    ...
    if (typeof endpoint === "string") {
      response = nodeType === "rest" ? (
         ...
         */
        await axios_default.get(`${endpoint}/cosmos/base/tendermint/v1beta1/node_info`)
      ) : (
        /**
         ...
         */
        await axios_default.post(endpoint)
      );
    } else {
      response = nodeType === "rest" ? (
        /**
         ...
         * information is available.
         */
        await axios_default.get(`${endpoint.url}/cosmos/base/tendermint/v1beta1/node_info`, {
         ...
         * SigningStargate also performs this internal check.
         */
        await axios_default.post(endpoint.url, {
          headers: endpoint.headers
        })
      );
    }
...
//# sourceMappingURL=chunk-7EEURKJ3.js.map
